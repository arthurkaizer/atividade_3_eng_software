...
public class DbOperations_Criminoso {
    ...
    public static void createRecord(Criminoso criminosoObj) {
        try {
            ...
            sessionObj.beginTransaction();            // Creating Transaction Entities
    ...
    public static List<Criminoso> displayRecords() {
        ...
        try {
            ...
            criminosoList = sessionObj.createQuery("from Criminoso_699742_701298").list();
    ...
    public static void deleteAllRecords() {
        try {
            ...
            Query queryObj = sessionObj.createQuery("DELETE from Criminoso_699742_701298_689386_698159");
    ...
    public static Criminoso getByName(String nomeDigitado) {
        ...
        try {
            ...
            findCriminosoObj = (Criminoso) sessionObj.createQuery("from Criminoso_699742_701298 where nome = :nome").setParameter("nome", nomeDigitado).uniqueResult();
